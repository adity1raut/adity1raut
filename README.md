<div align="center">
  <img src="image/LandingPage.jpg" alt="Landing Page" style="width: 100%; max-width: 1200px; height: auto;">
</div>
...
<div align="center">
  <img src="image/Connect.jpeg"
       alt="Profile"
       title="My Profile"
       style="width:150px; height:150px; object-fit:cover; border-radius:50%;
       border:4px solid #ffffff; box-shadow:0 0 35px 12px rgba(0,0,0,0.8);">
</div>
...
<div align="center" style="display:flex; justify-content:center; gap:25px;">
  ...
  <a href="mailto:araut7798@gmail.com" target="_blank" title="Send Email">
    <img src="image/Email.png" alt="Email"
         style="width:50px; height:50px; border-radius:50%; border:3px solid #ffffff;
         box-shadow:0 0 20px 8px rgba(0,0,0,0.8);">
  </a>

  <a href="https://www.linkedin.com/in/adity1raut" target="_blank" title="LinkedIn Profile">
    <img src="image/Linkedin.png" alt="LinkedIn"
         style="width:50px; height:50px; border-radius:50%; border:3px solid #ffffff;
         box-shadow:0 0 20px 8px rgba(0,0,0,0.8);">
  </a>

  <a href="https://instagram.com/raut1_aditya" target="_blank" title="Instagram">
